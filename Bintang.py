...
# Judul halaman dan hiasan
st.markdown(
    """
    <style>
    .css-18e3th9 {
        background-image: url("https://i.ibb.co/1n64TZK/background.jpg");
...
st.markdown(
    ...
    <div style="text-align: center;">
        ...
        <h2 style="font-size:30px;">Aksamla :sparkles:</h2>
    </div>
    """
    , unsafe_allow_html=True
)
